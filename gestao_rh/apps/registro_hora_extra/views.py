...
class ExportarParaCSV(View):
    def get(self, request):
        ...
        response['Content-Disposition'] = 'attachment; filename="RelatHoraExtra.csv"'

        registro_he = RegistroHoraExtra.objects.filter(utilizada=False).order_by('funcionario')
...
class ExportarExcel(View):
    def get(self, request):
        ...
        response['Content-Disposition'] = 'attachment; filename="RelatHoraExtra.xls"'
